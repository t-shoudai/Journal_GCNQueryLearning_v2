...
\begin{figure*}[tb]
  \centering
  \includegraphics[scale=0.6]{fig-counter_leaf_to_rake.eps}
...
\begin{figure*}[tb]
  \centering
  \includegraphics[scale=0.5]{fig-counter_step1_2.eps}
...
\begin{figure*}[tb]
  \centering
  \includegraphics[scale=0.5]{fig-counter_ldfs_tree.eps}
...
\begin{figure}[tb]
 ...
 %   \centering
    \includegraphics[scale=0.7]{fig-qltimes_input_min.eps}
...
\begin{figure}[tb]
  \centering
  \includegraphics[scale=0.34]{fig-qltimes_max_min.eps}
...
\begin{figure}[tb]
  ...
  %\begin{minipage}[c]{0.5\hsize}
  %  \centering
    \includegraphics[scale=0.7]{fig-qltimes_input_twice.eps}
